...
$trows2 = SqlExecOrDie($con,"
			...
			INNER JOIN ".TripConfig::NewsletterDB.".events e on t.eventid = e.id
...
$result["result"] = TripConfig::CtcDB.".trips is up to date - trips/participants".
