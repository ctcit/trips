(function () {
    ...
    angular.module('tripSignupApp').factory("TripDetail",
        ...
        function ($timeout) {
            ...
            function TripDetail(tripData, tripMetadata) {
                //"tripid": "57",
                //"eventid": "2662",
                //"date": "2016-03-20",
            ...
            angular.extend(TripDetail.prototype, {

                Date: function tripDate() {
                	return dow[this.date.getDay()] + " " + this.date.getDate() + " " + moy[this.date.getMonth()];
                },

                FullDate: function tripFullDate() {
                    return dow[this.date.getDay()] + " " + this.date.getDate() + " " + moy[this.date.getMonth()] + " " + this.date.getFullYear();
                }
